      ...
      <div className="bg-black/[0.3] absolute w-full h-full top-0 left-0 flex flex-col justify-center text-white">
        <ContentWrapper>
          <div className="max-w-[800px] lg:mt-[7%]">
            <h1 className="text-4xl uppercase font-thin sm:text-4xl md:text-5xl lg:text-[60px] xl:text-[80px] element-from-top">
              <span className="">Hello,</span>
              <span className="">{` I\'m `}</span>
              <span className="font-light block lg:inline-block">Roy Anonuevo</span>
            </h1>
            <p className="mt-2 leading-5 sm:text-base lg:text-lg element-from-top">A software engineer from the Philippines who is passionate about hiking, photography, web development and an amateur travel filmmaker.</p>
          </div>
        </ContentWrapper>
      </div>
    </section>
